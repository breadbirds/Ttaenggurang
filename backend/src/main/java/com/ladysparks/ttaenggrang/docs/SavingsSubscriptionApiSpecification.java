...
public interface SavingsSubscriptionApiSpecification {
    ...
    ResponseEntity<ApiResponse<List<SavingsSubscriptionDTO>>> savingsSubscriptionList(@RequestParam Optional<Long> studentId, @RequestParam Optional<Long> savingsProductId);
