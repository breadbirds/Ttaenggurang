...
초등학교 교실을 작은 사회로 운영하는 **교실 경제 활동**이 주목받고 있습니다.
정부의 **학생 1인 1태블릿 보급 정책**(2023년~)에 맞추고 현장의 문제를 해결하기 위해 태블릿 기반 경제 교육 서비스 **땡그랑**을 기획했습니다.
...
- 서비스 설명 :
    ...
    교사가 교실 경제를 운영하고, 학생이 급여·저축·투자·소비를 직접 체험하는 **태블릿 기반 초등 경제 교육 플랫폼**
